...
<html>
	...
	<body onload="fillNewReport()">
		<div id="container">
			...
			<div id="report">
			   		<form method="POST" action="preparedSqlForNewReport.php" >
						...
						<input id="patientId" type="text" readonly name="patientId"style="background:white;border: none;width: 80%;height: 30px;border-radius: 20px;outline: none;text-align: center;">
						...
						<button type="submit" name="submit" style="width: 100px;height: 30px;border-radius: 10px;border:none;margin-top: 20px;outline: none;">Create</button>
					</form>
		...
		<script src="fillNewForm.js"></script>
	</body>
</html>
